#include "Tests.h"
/*
void Test_Medikament::testMedikament1()
{
	//setup
	Medikament m("Paracetamol", 58.6, 100, 5);
...
void Test_MedikamentRepo::testAddMedikament2()
{
	...
	cout << lista.lista[0].getKonzentration() << '\n';;
...
/*
// nu prea am cum face verificarea la asta si la urmatoarea
void Test_MedikamentRepo::testGroupByPriceA()
{
	//setup
	MedikamentRepo lista;
	lista.addMedikament(Medikament("1", 1, 1, 1));
	...
	// de facut "clear contents of console"
}

// adica "si" la asta
void Test_MedikamentRepo::testGroupByPriceD()
{
	//setup
	MedikamentRepo lista;
	lista.addMedikament(Medikament("1", 1, 1, 1));
